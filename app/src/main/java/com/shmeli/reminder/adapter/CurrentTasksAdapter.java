...
//        DBHelper dbHelper = ((MainActivity) taskFragment.getActivity()).dbHelper.query().getTaskList();
//
//        itemList.addAll();
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch(viewType) {
            ...
            case TYPE_TASK:
                ...
                View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.model_task,
                                                                                viewGroup,
                                                                                false);
...
//    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if(item.isTask()) {
            ...
            separatorViewHolder.type.setText(resources.getText(separator.getType()));
        }
    }
